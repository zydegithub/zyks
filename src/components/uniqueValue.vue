  ...
  <div id="bodyContain">
    ...
    <div id="contain">
      ...
      <div class="tableContain">
        <el-table height="500" :data="fieldList" border :header-cell-style="{background:'#eef1f6',color:'#606266',fontSize:'16px'}" :cell-style="{fontSize:'16px'}" @selection-change="handleSelectionChange">
          <el-table-column type="selection" width="36px">
          </el-table-column>
          <el-table-column prop="color" label="符号" width="98px" align="center">
          ...
          <el-table-column prop="number" label="个数" width="98px" align="center">
          </el-table-column>
        </el-table>
      </div>
...
export default {
  ...
  methods: {
    ...
    addAllValue () {
      ...
      if (this.labelType == '1') {
        this.createRandomColor(this.fieldList.length, this.$refs.colorBand.colorBandIndex)
      } else {
