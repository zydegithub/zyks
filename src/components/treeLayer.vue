  ...
  methods: {
    ...
    handleNodeClick(data) {
      ...
      if (this.clickLayerType == 'circle') {
        this.color = this.map.getPaintProperty(this.clickLayerName, 'circle-color');
        this.width = this.map.getPaintProperty(this.clickLayerName, 'circle-radius');
      } else if (this.clickLayerType == 'line') {
        this.color = this.map.getPaintProperty(this.clickLayerName, 'line-color');
        this.width = this.map.getPaintProperty(this.clickLayerName, 'line-width');
        this.opacity = this.map.getPaintProperty(this.clickLayerName, 'line-opacity');
      } else if (this.clickLayerType == 'fill') {
        this.color = this.map.getPaintProperty(this.clickLayerName, 'fill-color');
        this.opacity = this.map.getPaintProperty(this.clickLayerName, 'fill-opacity');
      }
      this.dialogVisible = true;
    },
    editLayer() {
      if (this.clickLayerType == 'circle') {
        this.map.setPaintProperty(this.clickLayerName, 'circle-color', this.color);
        this.map.setPaintProperty(this.clickLayerName, 'circle-radius', parseFloat(this.width));
      } else if (this.clickLayerType == 'line') {
        this.map.setPaintProperty(this.clickLayerName, 'line-color', this.color);
        this.map.setPaintProperty(this.clickLayerName, 'line-width', parseFloat(this.width));
        this.map.setPaintProperty(this.clickLayerName, 'line-opacity', parseFloat(this.opacity));
      } else if (this.clickLayerType == 'fill') {
        this.map.setPaintProperty(this.clickLayerName, 'fill-color', this.color);
        this.map.setPaintProperty(this.clickLayerName, 'fill-opacity', parseFloat(this.opacity));
      }
